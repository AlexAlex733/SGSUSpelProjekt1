...
namespace Pathfinding {
	...
	public static class AstarUpdateChecker {
		...
		static void DownloadVersionInfo () {
			var script = AstarPath.active != null ? AstarPath.active : Object.FindFirstObjectByType(typeof(AstarPath)) as AstarPath;
			...
			bool mecanim = Object.FindFirstObjectByType(typeof(Animator)) != null;
